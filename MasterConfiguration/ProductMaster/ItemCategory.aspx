<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemCategory.aspx.cs" Inherits="Nexa_ERP.TrimsAccessories.MsterSetup.ItemCategory" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>Item Category Setup</title>
        ...
        <div class="container-fluid my-4 px-4">
            <div class="card shadow-sm">
                <div class="card-header card-header-custom py-2">
                    <h5 class="mb-0">Item Category Setup</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- বাম সাইড: ইনপুট ফর্ম -->
                        <div class="col-md-5 border-end pe-md-4">
                            <h6 class="text-primary fw-bold mb-3">Add / Update Category</h6>
                            <div class="mb-3">
                                <label class="form-label fw-bold">Category ID</label>
                                <asp:TextBox ID="txtCategoryId" runat="server" CssClass="form-control" placeholder="Category ID Auto Generated" ReadOnly="true"></asp:TextBox>
                            </div>
                            <div class="mb-3">
