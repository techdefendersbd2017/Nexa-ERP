<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemTypeSetup.aspx.cs" Inherits="Nexa_ERP.MerchandisingMarketing.BasicSetup.ItemTypeSetup" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Item Type Setup</title>
...
<body>
    <form id="form1" runat="server" class="min-h-screen p-2 mt-2">
        <div class="max-w-[1320px] w-full m-auto rounded-lg border">
            ...
            <%-- ============================================================ --%>
            <%-- LIST PANEL : Item Type List (opens first, always) --%>
            <asp:Panel ID="pnlList" runat="server">

                <div class="bg-[#255C8C] flex justify-between items-center rounded-t-lg px-4 py-2">
                    <div class="text-white">
                        <p class="text-xl mb-1 font-medium">Item Type List</p>
                    </div>
            ...
            <%-- ============================================================ --%>
            <%-- ENTRY PANEL : Item Type Info --%>
            <%-- ============================================================ --%>
            <asp:Panel ID="pnlEntry" runat="server" Visible="false">

                <div class="bg-[#255C8C] flex justify-between items-center rounded-t-lg px-4 py-2">
                    <div class="text-white">
                        <p class="text-xl mb-1 font-medium">Item Type Entry</p>
                    </div>
                ...
                <div class="bg-[#ffffff] shadow-xl rounded-b-lg p-4">
                    ...
                    <%-- Item Type Info box : centered --%>
                    <div class="flex justify-center">
                        <div class="w-full max-w-md bg-[#FBFCFE] p-3 rounded border border-gray-400">
                            <p class="text-sm font-semibold border-b border-gray-300 pb-1 mb-2">Item Type Info</p>
                            <div class="flex flex-col gap-2">

                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="text-sm font-medium">Item Type Name</label>
                                    <asp:TextBox ID="txtItemTypeName" placeholder="Item Type Name" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 py-1 focus:border-[#255C8C] shadow-sm transition duration-200 ease-in-out"></asp:TextBox>
                                </div>
