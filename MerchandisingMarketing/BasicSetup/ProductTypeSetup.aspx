<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductTypeSetup.aspx.cs" Inherits="Nexa_ERP.MerchandisingMarketing.BasicSetup.ProductTypeSetup" %>
...
<body>
    <form id="form1" runat="server" class="min-h-screen p-2 mt-2">
        <div class="max-w-[1320px] w-full m-auto rounded-lg border">
            ...
            <asp:Panel ID="pnlList" runat="server">
                ...
                <div class="bg-[#255C8C] flex justify-between items-center rounded-t-lg px-4 py-2">
                    <div class="text-white">
                        <p class="text-xl mb-1 font-medium">Product Type List</p>
                    </div>
            ...
            <%-- ============================================================ --%>
            <%-- ENTRY PANEL : Product Type Info --%>
            <%-- ============================================================ --%>
            <asp:Panel ID="pnlEntry" runat="server" Visible="false">

                <div class="bg-[#255C8C] flex justify-between items-center rounded-t-lg px-4 py-2">
                    <div class="text-white">
                        <p class="text-xl mb-1 font-medium">Product Type Entry</p>
                    </div>
                ...
                <div class="bg-[#ffffff] shadow-xl rounded-b-lg p-4">
                    ...
                    <%-- Product Type Info box : centered --%>
                    <div class="flex justify-center">
                        <div class="w-full max-w-md bg-[#FBFCFE] p-3 rounded border border-gray-400">
                            <p class="text-sm font-semibold border-b border-gray-300 pb-1 mb-2">Product Type Info</p>
