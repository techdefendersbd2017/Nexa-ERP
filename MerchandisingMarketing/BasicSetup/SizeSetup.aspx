<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SizeSetup.aspx.cs" Inherits="Nexa_ERP.MerchandisingMarketing.BasicSetup.SizeSetup" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Size Setup</title>
...
<body>
    <form id="form1" runat="server" class="min-h-screen p-2 mt-2">
        <div class="max-w-[1320px] w-full m-auto rounded-lg border">
            ...
            <asp:Panel ID="pnlList" runat="server">
                ...
                <div class="bg-[#255C8C] flex justify-between items-center rounded-t-lg px-4 py-2">
                    <div class="text-white">
                        <p class="text-xl mb-1 font-medium">Size List</p>
                    </div>
            ...
            <%-- ============================================================ --%>
            <%-- ENTRY PANEL : Size Info --%>
            <%-- ============================================================ --%>
            <asp:Panel ID="pnlEntry" runat="server" Visible="false">

                <div class="bg-[#255C8C] flex justify-between items-center rounded-t-lg px-4 py-2">
                    <div class="text-white">
                        <p class="text-xl mb-1 font-medium">Size Entry</p>
                    </div>
                ...
                <div class="bg-[#ffffff] shadow-xl rounded-b-lg p-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="bg-[#FBFCFE] p-3 rounded border border-gray-400">
                            <p class="text-sm font-semibold border-b border-gray-300 pb-1 mb-2">Size Info</p>
                            <div class="flex flex-col gap-2">

                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="text-sm font-medium">Buyer</label>
                                    <asp:DropDownList ID="ddlBuyer" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlBuyer_SelectedIndexChanged" CssClass="w-full border rounded outline-none border-gray-300 px-2 py-1 focus:border-[#255C8C] shadow-sm transition duration-200 ease-in-out">
                                        <asp:ListItem Value="" Selected="True">--Select Buyer--</asp:ListItem>
                                    </asp:DropDownList>
                                </div>

                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="text-sm font-medium">Size Name</label>
                                    <asp:TextBox ID="txtSizeName" placeholder="Size Name" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 py-1 focus:border-[#255C8C] shadow-sm transition duration-200 ease-in-out"></asp:TextBox>
                                </div>
                                ...
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="text-sm font-medium">Sorting No</label>
                                    <asp:TextBox ID="txtSortingNo" Text="0" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 py-1 focus:border-[#255C8C] shadow-sm transition duration-200 ease-in-out"></asp:TextBox>
                                </div>

                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="text-sm font-medium">Inseam</label>
                                    <asp:TextBox ID="txtInseam" Text="0" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 py-1 focus:border-[#255C8C] shadow-sm transition duration-200 ease-in-out"></asp:TextBox>
                                </div>

                                <div class="flex justify-end mt-1">
                                    <asp:CheckBox ID="chkActiveStatus" runat="server" Text="Active Status" Checked="true" CssClass="text-sm font-medium" />
                                </div>

                            </div>
                        </div>

                        <%-- right : sizes for this buyer --%>
                        <div class="bg-[#FBFCFE] p-3 rounded border border-gray-400 flex flex-col">
                            <div class="flex justify-end mb-2">
                                <asp:LinkButton ID="btnAddNewSize" runat="server" OnClick="btnAddNewSize_Click" CssClass="flex items-center gap-1.5 rounded bg-[#255C8C] text-white px-4 py-1.5 shadow-sm hover:bg-[#1a4569] cursor-pointer transition duration-200 ease-in-out font-medium text-sm no-underline justify-center">
                                    <i class="fa-solid fa-plus"></i>
                            ...
                            <div class="border border-gray-400 bg-gray-300 rounded w-full flex-1 overflow-y-auto overflow-x-auto" style="min-height:220px;">
                                <asp:GridView ID="gvSizesForBuyer" runat="server" EmptyDataText="No sizes available for this buyer."></asp:GridView>
                            </div>
                        </div>
