...
<div class="container-fluid main-container">
    ...
    <div class="page-heading">
        ...
        <div>
            <h3>Product Items Information</h3>
            <small>Merchandising &amp; Marketing &rsaquo; Merchandising Configuration &rsaquo; Items Information</small>
        </div>
    </div>
            ...
            <asp:Panel ID="PanelBuyingAgent" runat="server">
                <div class="card shadow right-panel">
                    ...
                    <div class="grid-wrapper">
                        <asp:GridView ID="gvItemsInformation"
                            runat="server"
                            CssClass="table table-bordered table-hover"
                            AutoGenerateColumns="False"
                            DataKeyNames="ItemsID"
                            Width="100%" OnSelectedIndexChanged="gvItemsInformation_SelectedIndexChanged">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ItemsID"
                                    HeaderText="ID" />

                                <asp:BoundField DataField="ItemsName"
                                    HeaderText="Items Name" />
