<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentSetting.aspx.cs" Inherits="Nexa_ERP.HRMPayroll.HRConfiguration.HRMSetting.DepartmentSetting" %>

<!DOCTYPE html>
<html>
<head runat="server">
    <title>Department Information - NexaERP</title>
...
<div class="container-fluid main-container">
    ...
    <div class="page-heading">
        ...
        <div>
            ...
            <small>HRM Configuration &rsaquo; HRM Setting &rsaquo; Department Setting</small>
        </div>
    </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body left-panel">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label>Department Name Local</label>
                            <asp:TextBox ID="txtDepartmentNameLocal" runat="server"
                                CssClass="form-control"
                ...
                <div class="grid-wrapper">
                    ...
                    <asp:GridView ID="gvDepartment"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Department_Code"
                                HeaderText="ID" />

                            <asp:BoundField DataField="Department_Name"
                                HeaderText="Department Name" />

                            <asp:BoundField DataField="DptPrefix"
                                HeaderText="Prefix" />

                            <asp:BoundField DataField="RequiredManpower"
                                HeaderText="Required Manpower" />

                            <asp:BoundField DataField="Extra_Required_Manpower"
