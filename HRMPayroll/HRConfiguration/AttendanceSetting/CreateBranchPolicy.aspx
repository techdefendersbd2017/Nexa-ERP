<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateBranchPolicy.aspx.cs" Inherits="Nexa_ERP.HRMPayroll.HRConfiguration.HRMSetting.CreateBranchPolicy" MaintainScrollPositionOnPostback="true" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Create Branch Policy - NexaERP</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid min-h-screen p-4 lg:p-6">
            ...
            <div class="flex items-center gap-3 mb-5">
                ...
                <div>
                    <h3 class="m-0 font-bold text-[#111827] text-xl tracking-tight">Attendance & Overtime Policy</h3>
                    <small class="block text-[#6b7280] font-normal text-xs mt-0.5">HRM Configuration &rsaquo; HRM Setting &rsaquo; Attendance & Overtime Policy</small>
                </div>
            </div>

            <!-- UpdatePanel to prevent screen shaking -->
            <asp:UpdatePanel ID="UPBranchPolicy" runat="server">
                <ContentTemplate>
                        ...
                        <div class="col-span-1 lg:col-span-7">
                            <div class="bg-white border border-[#e6e9ef] rounded-xl overflow-hidden shadow-sm flex flex-col">
                                ...
                                <div class="bg-gradient-to-r from-[#0d6efd] to-[#0b5ed7] text-white px-5 py-4 flex items-center gap-2.5">
                                    ...
                                    <h4 class="mb-0 text-[1rem] font-semibold tracking-wide">Policy Parameters</h4>
                                </div>
                                ...
                                <div class="p-5 overflow-y-auto lg:max-h-[calc(100vh-210px)]">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-4">
                                        ...
                                        <div class="flex flex-col">
                                            <label class="font-semibold text-[0.85rem] text-[#374151] mb-1.5">Policy ID</label>
                                            <asp:TextBox ID="txtPolicyId" ReadOnly="true" runat="server" 
                                        ...
                                        <div class="flex flex-col">
                                            <label class="font-semibold text-[0.85rem] text-[#374151] mb-1.5">Branch Name</label>
                                        ...
                                        <div class="flex flex-col">
                                            <label class="font-semibold text-[0.85rem] text-[#374151] mb-1.5">OT Calculation Type</label>
                                            <asp:DropDownList ID="DropDownList2" runat="server"
                                                CssClass="w-full bg-white border border-[#d7dce3] rounded-lg px-3 py-2 text-[0.92rem] outline-none focus:border-[#0d6efd] focus:ring-2 focus:ring-blue-100 transition-all shadow-sm appearance-none bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%236b7280%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E')] bg-[length:12px_12px] bg-[right_12px_center] bg-no-repeat pr-10">
                                                <asp:ListItem Text="-- Select --" Value="0" />                            
                                                <asp:ListItem Text="Hour" Value="1" />
                                                <asp:ListItem Text="Minite" Value="2" />
                                            </asp:DropDownList>
                                        </div>

                                        <div class="flex flex-col">
                                            <label class="font-semibold text-[0.85rem] text-[#374151] mb-1.5">Original OT Start</label>
                                            <asp:TextBox ID="txtOtDeductionOrg" runat="server" 
                                        ...
                                        <div class="flex flex-col">
                                            <label class="font-semibold text-[0.85rem] text-[#374151] mb-1.5">Compliance OT Start</label>
                                            <asp:TextBox ID="TextBox1" runat="server" 
                                                CssClass="w-full bg-white border border-[#d7dce3] rounded-lg px-3 py-2 text-[0.92rem] outline-none focus:border-[#0d6efd] focus:ring-2 focus:ring-blue-100 transition-all shadow-sm" />
                                        </div>

                                        <div class="flex flex-col">
                                            <label class="font-semibold text-[0.85rem] text-[#374151] mb-1.5">Extra OT Start</label>
                                            <asp:TextBox ID="txtOtStart" runat="server" 
                                                CssClass="w-full bg-white border border-[#d7dce3] rounded-lg px-3 py-2 text-[0.92rem] outline-none focus:border-[#0d6efd] focus:ring-2 focus:ring-blue-100 transition-all shadow-sm" />
                                        </div>

                                        <div class="flex flex-col">
                                            <label class="font-semibold text-[0.85rem] text-[#374151] mb-1.5">Out Time Start</label>
                                            <asp:TextBox ID="txtOutTimeStart" runat="server" 
                                                CssClass="w-full bg-white border border-[#d7dce3] rounded-lg px-3 py-2 text-[0.92rem] outline-none focus:border-[#0d6efd] focus:ring-2 focus:ring-blue-100 transition-all shadow-sm" />
                                        </div>

                                        <div class="flex flex-col">
                                            <label class="font-semibold text-[0.85rem] text-[#374151] mb-1.5">Early Out Grage Time</label>
                                            <asp:TextBox ID="txtEarlyDeductStart" runat="server" 
                                                CssClass="w-full bg-white border border-[#d7dce3] rounded-lg px-3 py-2 text-[0.92rem] outline-none focus:border-[#0d6efd] focus:ring-2 focus:ring-blue-100 transition-all shadow-sm" />
                                        </div>
                        ...
                        <div class="col-span-1 lg:col-span-5">
                            <div class="bg-white border border-[#e6e9ef] rounded-xl overflow-hidden shadow-sm flex flex-col">
                                ...
                                <div class="bg-gradient-to-r from-[#198754] to-[#157347] text-white px-5 py-4 flex items-center gap-2.5">
                                    ...
                                    <h4 class="mb-0 text-[1rem] font-semibold tracking-wide">Policy List</h4>
                                </div>

                                <!-- Grid Wrapper -->
                                <div class="grid-wrapper overflow-y-auto overflow-x-auto lg:max-h-[calc(100vh-210px)] min-h-[250px]">
                                    <asp:GridView ID="gvBranchPolicy" runat="server" CssClass="w-full border-collapse text-[0.88rem]"
                                        AutoGenerateColumns="False" DataKeyNames="PolicyID" Width="100%" OnSelectedIndexChanged="gvBranchPolicy_SelectedIndexChanged">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Branch_Name" HeaderText="OT Start" />
