    ...
    <form id="form1" runat="server" class="min-h-screen p-2 mt-2">
        ...
        <div class="max-w-[1320px] w-full m-auto rounded-lg border" id="Color">
            ...
            <div class="bg-[#255C8C] flex justify-between items-center rounded-t-lg px-4 py-2">
                ...
                <div class="flex items-end gap-4 bg-[#ffffff] px-8 py-2 rounded">
                    <!-- Cash Option -->
                ...
                <fieldset class="col-span-12 border border-gray-400 p-2 rounded bg-[#FBFCFE] mt-6">
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        ...
                        <div class="flex flex-col gap-0.5 w-full col-span-4">
                            ...
                            <asp:TextBox ID="txtAccountsHead" placeholder="e.g Accounts Head" TextMode="MultiLine" Rows="2" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 py-1 focus:border-[#255C8C] shadow-sm transition duration-200 ease-in-out"></asp:TextBox>
                        </div>
                        <div class="col-span-4">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <div class="flex gap-3 items-end justify-end col-span-3">
                                    <!-- Add Item Button -->
