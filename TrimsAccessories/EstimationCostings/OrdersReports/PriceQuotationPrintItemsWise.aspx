...
<html>
<head runat="server">
    <title>Price Quotation (Item-Wise) - Print</title>
    ...
    <script>
        ...
        function downloadPDF() {
            ...
            const options = {
                margin: 10,
                filename: 'PriceQuotation_ItemWise.pdf',
        ...
        function downloadExcel() {
            ...
            a.href = url;
            a.download = 'PriceQuotation_ItemWise_' + (document.getElementById('<%= lblQuotationCode.ClientID %>') ? document.getElementById('<%= lblQuotationCode.ClientID %>').innerText : 'Report') + '.xls';
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="report-container" id="reportContent">
            ...
            <div class="report-title">Price Quotation (Item-Wise Summary)</div>
            ...
            <asp:GridView ID="gvPrintDetails" runat="server" CssClass="detail-table" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundField DataField="SlNo" HeaderText="Sl" ItemStyle-CssClass="center" ItemStyle-Width="40px" />
                    <asp:BoundField DataField="ItemName" HeaderText="Item Name" />
                    <asp:BoundField DataField="ItemTotalCost" HeaderText="Total Cost" ItemStyle-CssClass="num" DataFormatString="{0:0.00}" ItemStyle-Width="120px" />
                </Columns>
            </asp:GridView>
