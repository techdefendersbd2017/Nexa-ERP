<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DispatchFromFinishing.aspx.cs" Inherits="Nexa_ERP.Production.Finishing.DispatchFromFinishing" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Dispatch From Finishing</title>
    ...
    <form id="form1" runat="server" class="min-h-screen p-2 mt-2">
        <div class="max-w-[1320px] w-full m-auto rounded-lg border">
            ...
            <div class="bg-[#0d6efd] text-white rounded-t-lg px-4 py-2">
                <p class="text-2xl mb-1">Dispatch From Finishing</p>
                <p class="">Label</p>
            </div>
            ...
            <div class="bg-[#f0f0f0] shadow-xl rounded-b-lg px-4 py-4">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <div class="grid grid-cols-2 gap-x-2 gap-y-1">
                                ...
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="whitespace-nowrap">Dispatch Fin. Id</label>
                                    <asp:TextBox ID="txtDispatchFinishingId" runat="server" ReadOnly="true" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                </div>
                                <div class="flex flex-col gap-0.5 w-full">
                                ...
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="whitespace-nowrap">NO.</label>
                                    <asp:DropDownList ID="ddlNo" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:DropDownList>
                                </div>
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="whitespace-nowrap">Send To</label>
                                    <asp:TextBox ID="txtSendTo" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                </div>
                                <div class="flex flex-col gap-0.5 w-full">
                                ...
                                <div class="flex gap-0.5 items-end col-span-2">
                                    <div class="flex flex-col gap-0.5 w-full">
                                        ...
                                        <asp:TextBox ID="txtColor" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                    </div>
                                    <div class="">
                        ...
                        <%-- top input --%>
                                ...
                                <div class="grid grid-cols-2 gap-x-2 gap-y-1">
                                    ...
                                    <div class="flex flex-col gap-0.5 w-full">
                                        ...
                                        <asp:TextBox ID="txtDispatch" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                    </div>
                                ...
                                <div class="flex flex-col gap-0.5 w-full">
                                    ...
                                    <asp:TextBox ID="txtDispatchQty" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                </div>
                            ...
                            <div class="col-span-4 flex flex-col h-full">
                                <div class="grid grid-cols-2 gap-x-2 gap-y-1">
                                    <div class="flex gap-0.5 items-end col-span-2">
                                        ...
                                        <asp:DropDownList ID="ddlDate4" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:DropDownList>
                                    </div>
                                </div>
                                <%-- list view --%>
                                <div class="border border-gray-400 bg-gray-300 rounded w-full flex-1 h-36 overflow-y-auto overflow-x-auto mt-2 mb-1">
                ...
                <div class="grid grid-cols-3 gap-x-2">
                    ...
                    <div class="flex flex-col gap-0.5 w-full">
                        ...
                        <asp:TextBox ID="txtTotalDispatch" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                    </div>
                </div>
