<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinishingReject.aspx.cs" Inherits="Nexa_ERP.Production.Finishing.FinishingReject" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Finishing Reject</title>
    ...
    <form id="form1" runat="server" class="min-h-screen p-2 mt-2">
        <div class="max-w-[1320px] w-full m-auto rounded-lg border">
            ...
            <div class="bg-[#0d6efd] text-white rounded-t-lg px-4 py-2">
                <p class="text-2xl mb-1">Finishing Reject</p>
                <p class="">Label</p>
            </div>
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <div class="grid grid-cols-3 gap-x-2 gap-y-1">
                                ...
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="whitespace-nowrap">Fin. Reject ID</label>
                                    <asp:TextBox ID="txtFinishingRejectId" runat="server" ReadOnly="true" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                </div>
                                <div class="flex flex-col gap-0.5 w-full">
                    ...
                    <div class="col-span-4 flex flex-col h-full">
                        ...
                        <div class="grid grid-cols-2 gap-x-2 gap-y-1">
                            ...
                            <div class="flex flex-col gap-0.5 w-full">
                                ...
                                <asp:TextBox ID="txtRejectType" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                            </div>
                            <div class="flex gap-0.5 items-end">
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label>Reject Qty</label>
                                    <asp:TextBox ID="txtRejectQty" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                </div>
