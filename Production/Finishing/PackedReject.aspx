<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackedReject.aspx.cs" Inherits="Nexa_ERP.Production.Finishing.PackedReject" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Packed Reject</title>
    ...
    <form id="form1" runat="server" class="min-h-screen p-2 mt-2">
        <div class="max-w-[1320px] w-full m-auto rounded-lg border">
            ...
            <div class="bg-[#0d6efd] text-white rounded-t-lg px-4 py-2">
                <p class="text-2xl mb-1">Packed Reject</p>
                <p class="">Label</p>
            </div>
            ...
            <div class="bg-[#f0f0f0] shadow-xl rounded-b-lg px-4 py-4">
                ...
                <div class="grid grid-cols-12 gap-x-3 gap-y-1 h-full">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <div class="grid grid-cols-2 gap-x-2 gap-y-1">
                                ...
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="whitespace-nowrap">Packed Reject ID</label>
                                    <asp:TextBox ID="txtPackedRejectId" runat="server" ReadOnly="true" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                </div>
                                <div class="flex flex-col gap-0.5 w-full">
                    ...
                    <%-- middle container list view --%>
                    <div class="col-span-4 flex flex-col h-full">
                        <div class="grid grid-cols-2 gap-x-2 gap-y-1">
                            <div class="flex flex-col gap-0.5 w-full">
                                <label class="whitespace-nowrap">Hold Type</label>
                                <asp:TextBox ID="txtHoldType" runat="server" ReadOnly="true" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                            </div>
                            <div class="flex items-end gap-2">
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="whitespace-nowrap">Qty</label>
                                    <asp:TextBox ID="txtQty" runat="server" ReadOnly="true" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                </div>
                        ...
                        <div class="flex flex-col gap-0.5 w-full">
                            <label class="whitespace-nowrap">Total Hold</label>
                            <asp:TextBox ID="txtTotalHold" runat="server" ReadOnly="true" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                        </div>
                    ...
                    <div class="col-span-4 flex flex-col h-full">
                        <div class="grid grid-cols-2 gap-x-2 gap-y-1">
                            <div class="flex flex-col gap-0.5 w-full">
                                ...
                                <asp:TextBox ID="txtRejectType" runat="server" ReadOnly="true" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                            </div>
                            <div class="flex items-end gap-2">
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="whitespace-nowrap">Reject Qty</label>
                                    <asp:TextBox ID="txtRejectQty" runat="server" ReadOnly="true" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                                </div>
                                <asp:Button ID="btnAdd4" runat="server" Text="Add" CssClass="rounded bg-[#22C55E] text-white px-4 py-0.5 shadow-sm hover:bg-[#16A34A] cursor-pointer transition delay-150 duration-300 ease-in-out" />
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col gap-0.5 w-full">
                            ...
                            <asp:TextBox ID="txtTotalReject" runat="server" ReadOnly="true" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                        </div>
                ...
                <div class="grid grid-cols-3 gap-x-2">
                    ...
                    <div class="flex flex-col gap-0.5 w-full">
                        ...
                        <asp:TextBox ID="txtTotalHold2" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                    </div>
                    <div class="flex flex-col gap-0.5 w-full">
                    ...
                    <div class="flex flex-col gap-0.5 w-full">
                        ...
                        <asp:TextBox ID="txtTotalMissing" runat="server" CssClass="w-full border rounded outline-none border-gray-300 px-2 h-7 focus:border-blue-500 shadow-sm transition delay-150 duration-150 ease-in-out"></asp:TextBox>
                    </div>
