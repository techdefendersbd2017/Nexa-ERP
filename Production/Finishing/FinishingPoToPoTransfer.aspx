<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinishingPoToPoTransfer.aspx.cs" Inherits="Nexa_ERP.Production.Finishing.FinishingPoToPoTransfer" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Finishing PO To PO Transfer</title>
    ...
    <form id="form1" runat="server" class="min-h-screen p-2 mt-2">
        <div class="max-w-[1320px] w-full m-auto rounded-lg border">
            ...
            <div class="bg-[#0d6efd] text-white rounded-t-lg px-4 py-2">
                <p class="text-2xl mb-1">Finishing PO To PO Transfer</p>
                <p class="">Label</p>
            </div>
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <div class="grid grid-cols-3 gap-x-2 gap-y-1">
                                ...
                                <div class="flex flex-col gap-0.5 w-full">
                                    <label class="whitespace-nowrap">Fin. PO Transfer ID</label>
                            ...
                            <fieldset class="border border-gray-400 rounded p-2">
                                ...
                                <div class="grid grid-cols-3 gap-x-2 gap-y-1">
                                    ...
                                    <div class="flex items-end">
                                        <asp:Button ID="btnStock" runat="server" Text="Stock" CssClass="rounded bg-[#22C55E] text-white px-4 py-0.5 shadow-sm hover:bg-[#16A34A] cursor-pointer transition delay-150 duration-300 ease-in-out" />
                                    </div>
                                </div>
                            </fieldset>
